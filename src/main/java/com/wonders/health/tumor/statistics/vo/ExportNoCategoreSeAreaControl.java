...
@Data
public class ExportNoCategoreSeAreaControl {
    ...
    @ExcelField(title="确诊检查数")
    private String qzjcs;  //确诊检查数

    @ExcelField(title="确诊检查率")
    private String qzjcl;  //确诊检查率

    @ExcelField(title="确诊癌病例数")
    private String qzabls;  //确诊癌病例数
