 ...
 * @author zhangyi
 */
public class LucFollow extends BaseEntity {
	...
	@Length(max=1)
	private String shifouquezhen;	// 是否确诊肺癌 字典表 id=60013 code=1：是；code=2：否
	...
	@Length(max=2)
	private String buzuoldctYuanyin;	// 不进行LDCT的原因 字典表 id=60029

	@Length(max=1)
	private String shifouldct;	// 是否进行LDCT检查 字典表 id=60013 code=1：是；code=2：否

	@Length(max=500)
	private String buzuoldctYuanyinQt;	// 不进行LDCT的原因其他

	@Length(max=1000)
	private String ldctJieguo;	// LDCT检查结果

	@Length(max=2)
	private String linchuangfenqi;	// 肺癌临床分期 字典表 id=60051
	...
	@JsonProperty("buzuoldctYuanyin")
	public String getBuzuoldctYuanyin() {
		return buzuoldctYuanyin;
	}

	public void setBuzuoldctYuanyin(String buzuoldctYuanyin) {
		this.buzuoldctYuanyin = buzuoldctYuanyin;
	}

	@JsonProperty("shifouldct")
	public String getShifouldct() {
		return shifouldct;
	}

	public void setShifouldct(String shifouldct) {
		this.shifouldct = shifouldct;
	}

	@JsonProperty("buzuoldctYuanyinQt")
	public String getBuzuoldctYuanyinQt() {
		return buzuoldctYuanyinQt;
	}

	public void setBuzuoldctYuanyinQt(String buzuoldctYuanyinQt) {
		this.buzuoldctYuanyinQt = buzuoldctYuanyinQt;
	}

	@JsonProperty("ldctJieguo")
	public String getLdctJieguo() {
		return ldctJieguo;
	}

	public void setLdctJieguo(String ldctJieguo) {
		this.ldctJieguo = ldctJieguo;
	}
