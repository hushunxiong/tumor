...
public class CancerPersonInfo extends BaseEntity {
    ...
    private String lucAssessmentResult; //危险度评估结果 cdc_dic_personinfo id=60001 code=1：阴性；code=2：阳性，对象一览上显示的字段为问卷初筛
    private String lucLdctResultType; //肺癌ldct检查结果类型1=阳性；2=阴性，对象一览上显示的字段为LDCT结果
    private String lucDiagCheckResult; //是否确诊为肺癌1:是；2:否, 对象一览上显示的字段为肺癌诊断结果
    ...
    public String getLucAssessmentResult() {
        return lucAssessmentResult;
    }

    public void setLucAssessmentResult(String lucAssessmentResult) {
        this.lucAssessmentResult = lucAssessmentResult;
    }

    public String getLucLdctResultType() {
        return lucLdctResultType;
    }

    public void setLucLdctResultType(String lucLdctResultType) {
        this.lucLdctResultType = lucLdctResultType;
    }

    public String getLucDiagCheckResult() {
        return lucDiagCheckResult;
    }

    public void setLucDiagCheckResult(String lucDiagCheckResult) {
        this.lucDiagCheckResult = lucDiagCheckResult;
    }
