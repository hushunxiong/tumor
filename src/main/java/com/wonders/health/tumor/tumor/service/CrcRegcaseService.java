...
public class CrcRegcaseService {
	...
	public DataGrid<CrcRegcase> findPage(DataGridSearch search) {
        ...
        if (count > 0) {
        	list = crcRegcaseDao.pageList(search);
        }
        return new DataGrid<CrcRegcase>(count,list);
    }
