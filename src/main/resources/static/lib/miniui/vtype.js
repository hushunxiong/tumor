...
/**
 * 校验只能输入字母和数字 备注：<input class="mini-textbox" vtype="EnglishAndNumber"/>
 */
mini.VTypes["EnglishAndNumberErrorText"] = "只能输入数字和字母";
mini.VTypes["EnglishAndNumber"] = function (v) {
    return $.trim(v) == "" || isEnglishAndNumber(v);
}
...
/**
 * 校验必须移动电话 备注：<input class="mini-textbox" vtype="mobile"/>
 */
...
/**
 * 校验必须移动电话 备注：<input class="mini-textbox" vtype="mobile1"/>
 */
...
/**
 * 校验必须电话 备注：<input class="mini-textbox" vtype="phone"/>
 */
...
/**
 * 校验必须移动电话 备注：<input class="mini-textbox" vtype="phone1"/>
 */
...
mini.VTypes["group"] = function (v, param) {
    ...
    for (var i = 0; i < param.length; i++) {
        if (param[0] == "mobile" && param[1] == "telephone") {
            ...
            mini.VTypes["groupErrorText"] = "手机号和固定电话至少填写一个";
        } else if (param[0] == "bryddh" && param[1] == "brgddh") {
            mini.VTypes["groupErrorText"] = "手机号和固定电话至少填写一个";
        ...
        } else if (param[0] == "mz" && param[1] == "qtmz") {
            mini.VTypes["groupErrorText"] = "民族和其他民族至少填写一个";
        } else if (param[0] == "cyzk" && param[1] == "zy") {
            mini.VTypes["groupErrorText"] = "从业状况和职业至少填写一个";
        } else {
            mini.VTypes["groupErrorText"] = "群组内组件至少有一个必填";
        }
