 ...
 * @author xuguobing
 */
public class LucFamilyCancerHistoryXHMain {
	...
	private static String[][] columns = new String[][]{
            ...
            {
                    "relation",/*列名*/
                    "亲属关系 cdc_dic_personinfo id=60018 code=20：子；code=30：女；code=51：父亲；code=52：母亲；code=70：兄弟姐妹",/*描述*/
                    "VARCHAR2",/*JDBC类型*/
                    "java.lang.String",/*JAVA类型*/
                    "relation",/*JAVA字段名:*/
                    "0",/*是否主键:1,是，0,非*/
            ...
            {
                    "lived",/*列名*/
                    "是否在世 cdc_dic_personinfo id=60019code=1：在世；code=2：过世",/*描述*/
                    "VARCHAR2",/*JDBC类型*/
                    "java.lang.String",/*JAVA类型*/
                    "lived",/*JAVA字段名:*/
                    "0",/*是否主键:1,是，0,非*/
    ...
    public static void main(String[] args) {
        ...
        configs.put("tableName", "luc_family_cancer_history_XH"); //表名称
        configs.put("ClassName", "LucFamilyCancerHistoryXH"); //java实体类名
        configs.put("functionName", "历史"); //表功能
        configs.put("functionAuthor", "xuguobing");//作者

        GenTable table = new GenTable();
        table.setSchema("ZLZFX");
        table.setTable("luc_family_cancer_history_XH");
