 ...
 * @author menglianghai
 */
public class CrcDiagCheckRemindMain {
	...
	private static String[][] columns = new String[][]{
            ...
            {
                    "first_remind_date",/*列名*/
                    "第一次提醒日期",/*描述*/
                    "DATE",/*JDBC类型*/
                    "java.util.Date",/*JAVA类型*/
                    "firstRemindDate",/*JAVA字段名:*/
                    "0",/*是否主键:1,是，0,非*/
                    "1",/*是否编辑:1,是，0,非*/
                    "1",/*是否列表:1,是，0,非*/
                    "0",/*是否查询:1,是，0,非*/
            ...
            {
                    "first_remind_type",/*列名*/
                    "第一次提醒方式 字典表 id=60047",/*描述*/
                    "VARCHAR2",/*JDBC类型*/
                    "java.lang.String",/*JAVA类型*/
                    "firstRemindType",/*JAVA字段名:*/
                    "0",/*是否主键:1,是，0,非*/
                    "1",/*是否编辑:1,是，0,非*/
                    "1",/*是否列表:1,是，0,非*/
                    "0",/*是否查询:1,是，0,非*/
            ...
            {
                    "second_remind_date",/*列名*/
                    "第二次提醒日期",/*描述*/
                    "DATE",/*JDBC类型*/
                    "java.util.Date",/*JAVA类型*/
                    "secondRemindDate",/*JAVA字段名:*/
                    "0",/*是否主键:1,是，0,非*/
                    "1",/*是否编辑:1,是，0,非*/
                    "1",/*是否列表:1,是，0,非*/
                    "0",/*是否查询:1,是，0,非*/
            ...
            {
                    "second_remind_type",/*列名*/
                    "第二次提醒方式 字典表 id=60047",/*描述*/
                    "VARCHAR2",/*JDBC类型*/
                    "java.lang.String",/*JAVA类型*/
                    "secondRemindType",/*JAVA字段名:*/
                    "0",/*是否主键:1,是，0,非*/
                    "1",/*是否编辑:1,是，0,非*/
                    "1",/*是否列表:1,是，0,非*/
                    "0",/*是否查询:1,是，0,非*/
            ...
            {
                    "third_remind_date",/*列名*/
                    "第三次提醒日期",/*描述*/
                    "DATE",/*JDBC类型*/
                    "java.util.Date",/*JAVA类型*/
                    "thirdRemindDate",/*JAVA字段名:*/
                    "0",/*是否主键:1,是，0,非*/
                    "1",/*是否编辑:1,是，0,非*/
                    "1",/*是否列表:1,是，0,非*/
                    "0",/*是否查询:1,是，0,非*/
            ...
            {
                    "third_remind_type",/*列名*/
                    "第三次提醒方式 字典表 id=60047",/*描述*/
                    "VARCHAR2",/*JDBC类型*/
                    "java.lang.String",/*JAVA类型*/
                    "thirdRemindType",/*JAVA字段名:*/
                    "0",/*是否主键:1,是，0,非*/
                    "1",/*是否编辑:1,是，0,非*/
                    "1",/*是否列表:1,是，0,非*/
                    "0",/*是否查询:1,是，0,非*/
            ...
            {
                    "remind_status",/*列名*/
                    "提醒状态 字典表 id=60048",/*描述*/
                    "VARCHAR2",/*JDBC类型*/
                    "java.lang.String",/*JAVA类型*/
                    "remindStatus",/*JAVA字段名:*/
                    "0",/*是否主键:1,是，0,非*/
                    "1",/*是否编辑:1,是，0,非*/
                    "1",/*是否列表:1,是，0,非*/
                    "0",/*是否查询:1,是，0,非*/
    ...
    public static void main(String[] args) {
        ...
        configs.put("tableName", "crc_diag_check_remind"); //表名称
        configs.put("ClassName", "CrcDiagCheckRemind"); //java实体类名
        configs.put("functionName", "大肠癌诊断检查提醒表"); //表功能
        configs.put("functionAuthor", "menglianghai");//作者

        GenTable table = new GenTable();
        table.setSchema("ZLZFX");
        table.setTable("crc_diag_check_remind");
