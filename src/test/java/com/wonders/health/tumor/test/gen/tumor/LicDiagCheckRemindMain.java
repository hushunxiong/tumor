 ...
 * @author menglianghai
 */
public class LicDiagCheckRemindMain {
    ...
    public static void main(String[] args) {
        ...
        configs.put("tableName", "lic_diag_check_remind"); //表名称
        configs.put("ClassName", "LicDiagCheckRemind"); //java实体类名
        configs.put("functionName", "肝癌诊断检查提醒表"); //表功能
        configs.put("functionAuthor", "menglianghai");//作者

        GenTable table = new GenTable();
        table.setSchema("ZLZFX");
        table.setTable("lic_diag_check_remind");
