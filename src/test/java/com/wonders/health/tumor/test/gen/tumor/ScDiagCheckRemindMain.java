 ...
 * @author menglianghai
 */
public class ScDiagCheckRemindMain {
    ...
    public static void main(String[] args) {
        ...
        configs.put("tableName", "sc_diag_check_remind"); //表名称
        configs.put("ClassName", "ScDiagCheckRemind"); //java实体类名
        configs.put("functionName", "胃癌诊断检查提醒表"); //表功能
        configs.put("functionAuthor", "menglianghai");//作者

        GenTable table = new GenTable();
        table.setSchema("ZLZFX");
        table.setTable("sc_diag_check_remind");
